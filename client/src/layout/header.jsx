        ...
        <React.Fragment>
          <li className="nav-item dropdown ml-auto">
            ...
            <div aria-labelledby="userInfo" className="dropdown-menu">
              <a href="#" className="dropdown-item"><strong className="d-block text-uppercase headings-font-family">{this.props.authData.userName}</strong><small>Web Developer</small>
              </a>
